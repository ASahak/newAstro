...
@Component({
  selector: 'app-south-ocean-page',
  templateUrl: './south-ocean-page.component.html',
  styleUrls: ['./south-ocean-page.component.css']
})
export class SouthOceanPageComponent implements OnInit {
