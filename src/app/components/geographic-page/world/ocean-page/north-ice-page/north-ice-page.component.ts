...
@Component({
  selector: 'app-north-ice-page',
  templateUrl: './north-ice-page.component.html',
  styleUrls: ['./north-ice-page.component.css']
})
export class NorthIcePageComponent implements OnInit {
