...
@Component({
  selector: 'app-atlantic-page',
  templateUrl: './atlantic-page.component.html',
  styleUrls: ['./atlantic-page.component.css']
})
export class AtlanticPageComponent implements OnInit {
