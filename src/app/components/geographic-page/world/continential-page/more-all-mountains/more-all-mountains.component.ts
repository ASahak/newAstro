...
@Component({
  selector: 'app-more-all-mountains',
  templateUrl: './more-all-mountains.component.html',
  styleUrls: ['./more-all-mountains.component.css']
})
export class MoreAllMountainsComponent implements OnInit {
  imageURL: string;
